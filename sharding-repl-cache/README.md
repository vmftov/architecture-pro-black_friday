...
В директории sharding-repl-cache выполнить команду:
...
В окне браузера должны отобразиться:
* данные mongo кластера - 2 шарда по 3 реплики
* статус кеширования - включено
* кол-во документов в коллекции helloDoc
...
* Открыть в браузере новую страницу
* Открыть в браузере инструменты разработчика
* Ввести в адресную строку адрес и перейти по нему  
    ```
    http://localhost:8080/helloDoc/users
    ```
* Отметить время выполнения запроса, например, **1,08с**
* Обновить страницу один-два раза и отметить время выполнения запроса. Оно должно стать меньше, например, **11мс**
